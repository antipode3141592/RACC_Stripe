...
Contributors: 
Version: 1.9
Date of Last Revision:  04/17/2019
*/
...
if(is_admin()) {
	...
	include(STRIPE_BASE_DIR . '/includes/shortcode-orgname.php');
	...
	include(STRIPE_BASE_DIR . '/includes/shortcode-email_editor.php');
	include(STRIPE_BASE_DIR . '/includes/email_editor_update.php');
}
